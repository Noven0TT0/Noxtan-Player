...
[![Build](https://github.com/abdallahmehiz/NoxtanPlayer/actions/workflows/build.yml/badge.svg)](https://github.com/abdallahmehiz/NoxtanPlayer/actions/workflows/build.yml)
## Additional features
- Nicer player UI
...
## Installation
you can download the app from the [Github releases page](https://github.com/abdallahmehiz/NoxtanPlayer/releases) or one of the official sources listed below:

[<img src="https://fdroid.gitlab.io/artwork/badge/get-it-on-en.svg" height="80">](https://f-droid.org/en/packages/live.mehiz.NoxtanPlayer/)
[<img src="https://gitlab.com/IzzyOnDroid/repo/-/raw/master/assets/IzzyOnDroid.png" height="80">](https://apt.izzysoft.de/fdroid/index/apk/live.mehiz.NoxtanPlayer)
[<img src="https://play.google.com/intl/en_us/badges/static/images/badges/en_badge_web_generic.png" height="80">](https://play.google.com/store/apps/details?id=live.mehiz.NoxtanPlayer)

You can also access nightly builds from [here](https://github.com/abdallahmehiz/NoxtanPlayer/actions/workflows/nightlies.yml)
## Acknowledgments
