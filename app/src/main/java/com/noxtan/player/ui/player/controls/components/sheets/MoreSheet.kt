...
import com.noxtan.player.presentation.components.PlayerSheet
    ...
    Column(
      ...
      Row(
        ...
        Row(
          ...
          IconToggleButton(
            checked = autoPipMode,
            onCheckedChange = { playerPreferences.autoPipMode.set(it) }
          ) {
            Icon(
              ...
              tint = if (autoPipMode) MaterialTheme.colorScheme.primary else androidx.compose.material3.LocalContentColor.current
            )
          }
          ...
          TextButton(onClick = onEnterSwipeProtector) {
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(MaterialTheme.spacing.extraSmall)) {
              ...
              Text(text = "Swipe Protector")
            }
          }

          // Eye Care
          TextButton(onClick = onEnterEyeCare) {
            Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(MaterialTheme.spacing.extraSmall)) {
