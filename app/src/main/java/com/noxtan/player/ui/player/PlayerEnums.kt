...
import com.noxtan.player.preferences.preference.Preference
...
enum class PlayerOrientation(@StringRes val titleRes: Int) {
  ...
  ReverseLandscape(R.string.pref_player_orientation_reverse_portrait),
...
enum class EdgeTarget { Left, Right, Both }
enum class EdgeOrientation { Portrait, Landscape, Both }
