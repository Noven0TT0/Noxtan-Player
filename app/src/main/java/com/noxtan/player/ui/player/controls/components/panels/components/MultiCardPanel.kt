package com.noxtan.player.ui.player.controls.components.panels.components
...
import com.noxtan.player.ui.player.controls.CARDS_MAX_WIDTH
...
fun MultiCardPanel(
  ...
  val shadowBlur = if (isLowEnd) 0f else 20f
        ...
        TopAppBar(
          title = {
            Text(
              ...
              style = MaterialTheme.typography.headlineMedium.copy(shadow = Shadow(blurRadius = shadowBlur)),
            )
          },
          navigationIcon = {
        ...
        Row(
          ...
          Text(
            ...
            style = MaterialTheme.typography.headlineMedium.copy(
              shadow = Shadow(blurRadius = shadowBlur),
            ),
          )
